...
set(SINGLEAPPLICATION_VERSION_RPM_V   "${majorminorpatch}")
set(SINGLEAPPLICATION_VERSION_RPM_R   "1")
set(SINGLEAPPLICATION_VERSION_PAC_V   "${majorminorpatch}")
set(SINGLEAPPLICATION_VERSION_PAC_R   "1")
...
if(GIT_REVISION)
  ...
  set(SINGLEAPPLICATION_VERSION_RPM_V   "${GIT_TAGNAME}")
  set(SINGLEAPPLICATION_VERSION_RPM_R   "2.${GIT_COMMITCOUNT}.${GIT_SHA1}")
  set(SINGLEAPPLICATION_VERSION_PAC_V   "${GIT_TAGNAME}")
  set(SINGLEAPPLICATION_VERSION_PAC_R   "${GIT_COMMITCOUNT}")

endif()

message(STATUS "SingleApplication Version:")
message(STATUS "Display:  ${SINGLEAPPLICATION_VERSION_DISPLAY}")
message(STATUS "Package:  ${SINGLEAPPLICATION_VERSION_PACKAGE}")
message(STATUS "RPM:      ${SINGLEAPPLICATION_VERSION_RPM_V}-${SINGLEAPPLICATION_VERSION_RPM_R}")
message(STATUS "PAC:      ${SINGLEAPPLICATION_VERSION_PAC_V}-${SINGLEAPPLICATION_VERSION_PAC_R}")
